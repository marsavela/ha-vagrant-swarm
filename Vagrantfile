...
manager_ip = "#{ip_range}2"

instances = [{:name => "manager", :ip => "#{manager_ip}"}]
...
Vagrant.configure("2") do |config|
  ...
  # config.vm.provision "shell", inline: "docker stack deploy -c /vagrant/docker-compose.yml skyinterview"
end
